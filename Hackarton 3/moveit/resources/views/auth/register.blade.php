<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="height" class="block mt-1 w-full" type="number" step="0.01" name="height" :value="old('height')" required autocomplete="height" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="weight" class="block mt-1 w-full" type="number" name="weight" :value="old('weight')" required autocomplete="weight" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="interests" class="block mt-1
            w-full" type="text" name="interests" :value="old('interests')" required autocomplete="interests" />
